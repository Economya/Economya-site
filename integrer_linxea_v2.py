...
# -*- coding: utf-8 -*-
"""
Intégration du bloc partenaire Linxea — deuxième vague (4 articles)
À lancer UNE SEULE FOIS depuis le dossier ~/Desktop/mon site
APRÈS integrer_linxea.py (premiere vague de 6 articles)

Idempotent. Sauvegarde en .bak_linxea2 avant modification.

Usage :
    python3 integrer_linxea_v2.py
"""
...
def traiter_fichier(chemin):
    ...
    with open(chemin + ".bak_linxea2", 'w', encoding='utf-8') as f:
        f.write(contenu)
