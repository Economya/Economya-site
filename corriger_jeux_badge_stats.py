...
REMPLACEMENTS = [
    ...
    (
        '<div class="hstat"><span class="hstat-val">10</span><span class="hstat-lbl">Jeux disponibles</span></div>',
        '<div class="hstat"><span class="hstat-val">12</span><span class="hstat-lbl">Jeux disponibles</span></div>',
    ),
]
