...
CORRECTIONS = {
    "article-230.html": [
        (
            '<div class="prime-plafond">7,18 €</div>',
            '<div class="prime-plafond">7,32 €</div>',
        ),
        (
            '<span class="simul-lab">Titres-restaurant (180 jours × 7,18 € patronal)</span><span class="simul-val gold">+ 1 292 € nets</span>',
            '<span class="simul-lab">Titres-restaurant (180 jours × 7,32 € patronal)</span><span class="simul-val gold">+ 1 318 € nets</span>',
        ),
        (
            '<span class="simul-lab">Total avantages non imposables</span><span class="simul-val gold">5 397 € nets</span>',
            '<span class="simul-lab">Total avantages non imposables</span><span class="simul-val gold">5 423 € nets</span>',
        ),
    ],
    "article-123.html": [
        (
