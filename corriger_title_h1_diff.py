...
CORRECTIONS = {
    ...
    "article-1.html": [
        (
            "<title>Les 8 apps pour ne plus payer plein tarif au supermarché — Economya.fr</title>",
            "<title>Les 8 apps pour ne plus jamais payer plein tarif au supermarché — Economya.fr</title>",
        ),
    ],
    "article-201.html": [
        (
            "<title>Acheter sa résidence principale : le guide 2026 — Economya.fr</title>",
            "<title>Acheter sa résidence principale : le guide complet 2026 — Economya.fr</title>",
        ),
    ],
    "article-237.html": [
        (
            "<title>Téléconsultation médicale gratuite — Economya.fr</title>",
            "<title>Téléconsultation médicale : consulter gratuitement — Economya.fr</title>",
        ),
    ],
    "article-241.html": [
        (
            "<title>PUMA : protection universelle maladie — Economya.fr</title>",
            "<title>PUMA : droits automatiques à la Sécu — Economya.fr</title>",
        ),
    ],
    "article-247.html": [
        (
            "<title>IA pour économiser au quotidien : les meilleurs outils — Economya.fr</title>",
            "<title>IA pour économiser : les meilleurs outils gratuits — Economya.fr</title>",
        ),
    ],
    "article-268.html": [
        (
            "<title>Location longue durée vs achat : que choisir — Economya.fr</title>",
            "<title>LLD vs achat : le vrai calcul — Economya.fr</title>",
        ),
    ],
    "article-451.html": [
        (
            "<title>Comptes dormants : récupérer son dû à la Caisse des Dépôts — Economya.fr</title>",
            "<title>Comptes dormants : procédure pour récupérer son dû — Economya.fr</title>",
        ),
    ],
}
